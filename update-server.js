...
const STATE_FILE = "painel/state.json"
...
await page.goto(
  "https://ifscgaropaba.edupage.org/timetable/",
...
await page.waitForSelector("table", { timeout: 15000 });
  ...
  // cabeçalho
  const headerTds = trs[0].querySelectorAll("td, th");

  headerTds.forEach(td => {
    resultado.cabecalho.push(td.innerText.trim());
  });
  ...
  console.log("Ensalamento capturado:", tabela);
  await browser.close();
